...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Trinity server stopping";
}
...
//
// JSON-RPC protocol.  Trinity speaks version 1.0 for maximum compatibility,
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use trinityd";
    ...
    ip::tcp::endpoint endpoint(bindAddress, GetArg("-rpcport", 6420));
...
Object CallRPC(const string& strMethod, const Array& params)
{
    ...
    if (!d.connect(GetArg("-rpcconnect", "127.0.0.1"), GetArg("-rpcport", "6420")))
